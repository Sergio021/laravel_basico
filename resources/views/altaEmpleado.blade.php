...
<form action = "{{route('guardarEmpleado')}}" method = "POST" enctype="multipart/form-data">
    ...
    <div class="well">
      <div class="form-group">
          ...
          <input type="text" name="ide" id="ide" class="form-control" placeholder="Clave empleado" tabindex="5" value="{{$siguiente}}" readonly="readonly">
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">
                ...
                <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre" tabindex="1" value="{{ old('nombre')}}">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="apellido" id="apellido" class="form-control" placeholder="Apellido" tabindex="2" value="{{ old('apellido')}}">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control" placeholder="Email" tabindex="4" value="{{ old('email')}}">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="celular" id="celular" class="form-control" placeholder="Celular" tabindex="3" value="{{ old('celular')}}">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
              <div class="form-group">
                ...
                <select name = 'idd' class="custom-select" required>
